      ...
      <div className="flex items-center justify-between pb-4 border-b border-white/5 shrink-0">
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs font-mono text-slate-500 uppercase tracking-widest mt-1">Personnel Authentication Summary Ledger</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 shrink-0">
        ...
        <div className="bg-black/30 border border-white/[0.03] p-5 rounded-2xl font-mono shadow-inner">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-xs font-bold text-slate-200 uppercase">{(currentUser.barangayId?.toUpperCase() || "GLOBAL")} SECTOR DETACHMENT</span>
          </div>
        </div>
      </div>
